...
#block(
  ...
  *Warunki początkowe:*
  ...
  Dla indeksu 121261: $X = 6$ (przedostatnia cyfra)
...
#block(
  ...
  #v(0.5em)
  #align(center)[
    Warunki początkowe: $x(0) = 0$, $x'(0) = 1.0$
  ]
]
...
#align(center)[
  #figure(
    image("spr-2.1/model-2.1.1.png", width: 88%),
...
#align(center)[
  #figure(
    image("spr-2.1/model-2.1.2.png", width: 88%),
...
#align(center)[
  #figure(
    image("spr-2.1/result-2.1.1.png", width: 88%),
...
#align(center)[
  #figure(
    image("spr-2.1/result-2.1.2.png", width: 88%),
...
#block(
  ...
  *Warunki początkowe:*
  ...
  Dla indeksu 121261: $X = 6$ (przedostatnia cyfra), $Y = 1$ (ostatnia cyfra)
  ...
  #align(center)[
    #table(
      ...
      [0], [X/3 = 6/3 = 2.0], [0.6 + Y/2 = 0.6 + 0.5 = 1.1],
    )
  ]
]
...
#block(
  ...
  #v(0.5em)
  #align(center)[
    Warunki początkowe: $y(0) = 0$, $x(0) = 2.0$, $x'(0) = 1.1$
  ]
]
...
#align(center)[
  #figure(
    image("spr-2.2/model-2.2.1.png", width: 88%),
...
#align(center)[
  #figure(
    image("spr-2.2/model-2.2.2.png", width: 88%),
...
#align(center)[
  #figure(
    image("spr-2.2/result-2.2.1-first.png", width: 88%),
...
#align(center)[
  #figure(
    image("spr-2.2/result-2.2.1-second.png", width: 88%),
...
#align(center)[
  #figure(
    image("spr-2.2/result-2.2.2.png", width: 88%),
...
Układ równań wykazuje zachowanie oscylacyjne z tłumieniem. Wartości początkowe $x(0) = 2.0$ i $x'(0) = 1.1$ wpływają na amplitudę początkowych oscylacji. Oba warianty implementacji dają identyczne wyniki.
...
#align(center)[
  #figure(
    image("spr-2.3/model-2.3.png", width: 90%),
...
#align(center)[
  #figure(
    image("spr-2.3/result-2.3.png", width: 88%),
...
Układ regulacji stabilizuje temperaturę wokół wartości zadanej $T_1 = 2 degree C$. Element histerezowy powoduje oscylacje temperatury w zakresie określonym przez strefę nieczułości $|w| <= 0.18$. Błąd regulacji $Delta T$ zmienia się cyklicznie, co jest charakterystyczne dla regulatorów dwupołożeniowych z histerezą.
